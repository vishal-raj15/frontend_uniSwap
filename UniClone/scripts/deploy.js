...
async function main() {
    ...
    console.log( "ooooooooooooooooooh");
    ...
    const token2 = await Token2.deploy(1000);
    
    await factory.createPair(token1.address, token2.address);

    console.log("Account balance after deploy:", (await ethers.provider.getBalance(deployer.address)).toString());
